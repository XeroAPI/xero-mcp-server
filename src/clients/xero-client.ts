...
class CustomConnectionsXeroClient extends MCPXeroClient {
  ...
  public async getClientCredentialsToken(): Promise<TokenSet> {
    const scope =
      "accounting.transactions accounting.attachments accounting.contacts accounting.settings accounting.reports.read files payroll.settings payroll.employees payroll.timesheets";
