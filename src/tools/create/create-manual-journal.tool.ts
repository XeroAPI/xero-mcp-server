...
const CreateManualJournalTool = CreateXeroTool(
  ...
  Retrive a list of account codes in Xero to use for the journal lines.\
  journal lines must contain at least two individual journal line with account codes, \
